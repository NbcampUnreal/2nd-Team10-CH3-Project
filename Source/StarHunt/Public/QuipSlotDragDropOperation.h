...
#include "QuipSlotDragDropOperation.generated.h"

/**
 * 
 */
UCLASS()
class STARHUNT_API UQuipSlotDragDropOperation : public UDragDropOperation, public IItemDragDropOperationInterface
{
	GENERATED_BODY()
